...
public class MealTestData {
    ...
    public static final Meal emptyMeal = new Meal(LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS), "", 1000);

    public static final List<Meal> meals = List.of(meal7, meal6, meal5, meal4, meal3, meal2, meal1);
    public static final URI TEST_MEAL_URI = ServletUriComponentsBuilder
            .fromCurrentContextPath()
            .path("/rest/meals/{id}")
            .buildAndExpand(MealTestData.meal1.getId())
            .toUri();
